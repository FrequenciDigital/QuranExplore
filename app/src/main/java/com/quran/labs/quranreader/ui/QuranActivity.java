...
import com.quran.labs.quranreader.AboutUsActivity;
...
import com.quran.labs.quranreader.ShortcutsActivity;
...
import com.quran.labs.quranreader.ui.fragment.JuzListFragment;
import com.quran.labs.quranreader.ui.fragment.SuraListFragment;
...
import com.quran.labs.quranreader.widgets.SlidingTabLayout;
    ...
    switch (item.getItemId()) {
      ...
      case R.id.other_apps: {
        ...
        if (getPackageManager().resolveActivity(intent,
          ...
          intent.setData(Uri.parse("https://play.google.com/store/apps/developer?id=Hero+of+the+Sun"));
        }
